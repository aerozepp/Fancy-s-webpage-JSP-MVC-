...
public class Dao {
	...
	public void registration(String username, String password, String imgName) {
	...
	public ArrayList<Dto_Topics> messageView(String cur_page) {
		...
		try {
			...
			while (resultSet.next()) {
				...
				String query_img = "SELECT * FROM users WHERE usernames = ?";
				preparedStatement2 = connection.prepareStatement(query_img);
				preparedStatement2.setString(1, authors);
				resultSet2 = preparedStatement2.executeQuery();
				String imgName = null
						;
				while(resultSet2.next()){
					imgName = resultSet2.getString("imgName");
				}
				...
				Dto_Topics dto = new Dto_Topics(topic_id, authors, titles, texts, topicDate, likes, replies,
						topic_total, current_page, start_topic, imgName);
				dtos.add(dto);
	...
	public Dto_Topics contentView(String topic_id) {
		...
		try {
			...
			while (resultSet.next()) {
				...
				int likes = resultSet.getInt("likes");
				int replies = resultSet.getInt("replies");
				String imgName = getImgName(authors);
				
				dto = new Dto_Topics(topics_id, authors, titles, texts, topicDate, likes, replies, 0, 0, imgName);
	...
	public ArrayList<Dto_Topics> replyView(String topic_id) {
		...
		try {
			...
			while (resultSet.next()) {
				...
				dto = new Dto_Topics(rep_id, authors, texts, rep_date, imgName);
				dtos.add(dto);
			}
	...
	public void replyDelete(String reply_id, String topic_id){
		
		int reply_index = Integer.parseInt(reply_id);
		int topic_index = Integer.parseInt(topic_id);
		...
		try {
			...
			preparedStatement = connection.prepareStatement(query);
			preparedStatement.setInt(1, reply_index);
			preparedStatement.executeUpdate();
			preparedStatement.executeUpdate();
	...
	public String getImgName(String author){
		PreparedStatement preparedStatement2 = null;
		Connection connection = null;
		ResultSet resultSet2 = null;
		...
		try {
			String query_img = "SELECT * FROM users WHERE usernames = ?";
			preparedStatement2 = connection.prepareStatement(query_img);
			preparedStatement2.setString(1, author);
			resultSet2 = preparedStatement2.executeQuery();
