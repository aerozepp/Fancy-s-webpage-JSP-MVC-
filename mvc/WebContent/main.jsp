...
<!-- <div id="registration_div">
		<form name="registration" action="registration.do" method="POST">
			<input type="text" name="username" placeholder="사용자이름(6~10자)"
				maxlength="10"> <input type="submit"
				formaction="id_check.do" value="중복확인"><br> <input
				type="password" name="password" placeholder="비밀번호(6~10자)"
				maxlength="10"><br> <input type="password"
				name="password_confirm" placeholder="비밀번호 확인" maxlength="10"><br>
			<input type="button" value="확인"
				onclick="registration_validation(document.registration.username, document.registration.password, document.registration.password_confirm)">
		</form>
	</div>
	<hr>
	<br> -->
...
<!-- 	<div id="login">
		<form action="login.do" method="POST">
			...
			<input type="password" name="password" placeholder="비밀번호"
				maxlength="10"><br> <input type="submit" name="submit"
				value="확인">
		</form>
	</div> -->
...
<body>
	...
	<div id="cover">
		<div class="container">
			<div class="img">
				<a href="main.jsp"><img id="logo" src="img/fancys_logo.jpg"></a>
			</div>
	...
	<div id="signin_box">
		<div class="signin_btn">
			<%@ include file="jsp/isLoggedIn.jsp"%>
		</div>
	</div>
